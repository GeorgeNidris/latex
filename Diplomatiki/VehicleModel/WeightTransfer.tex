...
\begin{equation}
    \begin{aligned}
       ...
       F_{z,RL} &= F_{z,static,r} +\dfrac{WT_{long}}{2} - D_{roll}WT_{lat} + \dfrac{F_{z,r,lift}}{2}\\[10pt]
       F_{z,RR} &= F_{z,static,r} +\dfrac{WT_{long}}{2} + D_{roll}WT_{lat} + \dfrac{F_{z,r,lift}}{2}
    \end{aligned}
    \label{eq:normalLoads}
\end{equation}

Σημειώνεται η χρήση της παραμέτρου $D_{roll} \in [0,1]$. Στην πραγματικότητα, η εγκάρσια μεταφορά βάρους δεν ισομοιράζεται στους δύο άξονες, αλλά επηρεάζεται έντονα
